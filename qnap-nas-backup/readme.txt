...
**This plugin needs to be run with the Multi-Application Recovery Service (MARS).**
...
Tutorial: [https://youtu.be/bs79Ji5Y8JY](https://youtu.be/bs79Ji5Y8JY)
Learn more: [https://qnap.to/48qpmb](https://qnap.to/48qpmb)

== Installation ==

1. QNAP NAS Backup can be installed directly through your WordPress plugins dashboard.
1. Click "Add New" and Search for "QNAP"
